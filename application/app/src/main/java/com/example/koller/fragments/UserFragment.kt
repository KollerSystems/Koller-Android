...
class UserFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val includeHeader : View = view.findViewById(R.id.include_header)
        var textName : TextView = view.findViewById(com.example.shared.R.id.user_text_name)
        var textDescription : TextView = view.findViewById(com.example.shared.R.id.user_text_description)
        var imagePfp : ImageView = view.findViewById(com.example.shared.R.id.user_image_pfp)
