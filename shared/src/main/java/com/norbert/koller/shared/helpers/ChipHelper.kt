...
class ChipHelper {
    ...
    companion object{
        fun getDateFilterValue(viewModel: ListApiViewModel) : MutableMap<String, Pair<Long, Long>>{
            return viewModel.dateFilters
        }

        fun getFilterValue(viewModel: ListApiViewModel) : MutableMap<String, MutableSet<Int>>{
            return viewModel.filters
        }

        fun changeFilterValue(viewModel: ListApiViewModel, filterName : String, selection : MutableSet<Int>){
            getFilterValue(viewModel)[filterName] = selection
            viewModel.onChipsChanged?.invoke()
        }

        fun changeDateFilterValue(viewModel: ListApiViewModel, filterName : String, selection : Pair<Long, Long>){
            getDateFilterValue(viewModel)[filterName] = selection
            viewModel.onChipsChanged?.invoke()
        }

        fun removeFilterValue(viewModel: ListApiViewModel, filterName : String){
            getFilterValue(viewModel).remove(filterName)
            viewModel.onChipsChanged?.invoke()
        }

        fun removeDateFilterValue(viewModel: ListApiViewModel, filterName : String = "Date"){
...
fun Chip.connectToDateRangePicker(fragment : androidx.fragment.app.Fragment, filterName : String = "Date", viewModel: ListApiViewModel, localizedId : Int){
...
fun Chip.connectToDateRangePickerWithTemplates(fragment : androidx.fragment.app.Fragment, filterName : String = "Date", viewModel: ListApiViewModel){
...
fun Chip.resetChip(localizedNameSting : String, viewModel: ListApiViewModel, filterName : String){
    ChipHelper.removeFilterValue(viewModel, filterName)
    resetSimpleChip(localizedNameSting)
}

fun Chip.setChip(localizedNameSting : String, localizedFilterId : Int, viewModel: ListApiViewModel, filterName : String){
    checkByPass(true)
...
fun Chip.handleValuesOnFinish(fragment : androidx.fragment.app.Fragment, dialog : ListBsdfFragment, viewModel: ListApiViewModel, filterName: String, localizedFilterId: Int){
    ...
    dialog.show(fragment.parentFragmentManager, ListBsdfFragment.TAG)
}

fun Chip.connectToCheckBoxList(fragment : androidx.fragment.app.Fragment, filterName : String, localizedFilterId : Int, apiDataObject: ApiDataObject, viewModel: ListApiViewModel, collapseText : Boolean){
...
fun Chip.connectToCheckBoxList(fragment : androidx.fragment.app.Fragment, filterName : String, localizedFilterId : Int, arrayList : ArrayList<ListItem>, viewModel: ListApiViewModel){
