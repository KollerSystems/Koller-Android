...
class ObsRecyclerAdapter (private var todayList : ArrayList<TodayData>) : RecyclerView.Adapter<ObsRecyclerAdapter.TodayViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TodayViewHolder {
        ...
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_readable, parent, false)
