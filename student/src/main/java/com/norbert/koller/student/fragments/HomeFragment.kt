...
class HomeFragment : com.norbert.koller.shared.fragments.HomeFragment() {
    ...
    fun setupHome(){
        ...
        val textLessonsSilenceWarning : TextView = requireView().findViewById(R.id.home_text_silence_warning)

        val textLessonsTitle : TextView = requireView().findViewById(Rs.id.text_lessons_title)
        val textLessonsDescription : TextView = requireView().findViewById(Rs.id.text_lessons_description)
        val textLessonsNumber : TextView = requireView().findViewById(Rs.id.text_lessons_number)
        val textLessonsTime : TextView = requireView().findViewById(Rs.id.text_lessons_time)

        val realViewLessonsNext : View = requireView().findViewById(Rs.id.home_layout_lessons_next)
        var textSmallLessonsTitle : TextView = requireView().findViewById(Rs.id.home_text_small_lessons_title)
        var textSmallLessonsDescription : TextView = requireView().findViewById(Rs.id.home_text_small_lessons_description)
        val textSmallLessonsNumber : TextView = requireView().findViewById(Rs.id.home_text_small_lessons_number)
        val textSmallLessonsTime : TextView = requireView().findViewById(Rs.id.home_text_small_lessons_time)
        ...
        val textNow : TextView = requireView().findViewById(com.norbert.koller.shared.R.id.home_text_now)
